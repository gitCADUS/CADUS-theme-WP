<?php
/**
 * Displays the content when the cover template is used for CADUS Theme
 *
 * @author Carlos Cruz
 * @since CADUS 1.0
 */
...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
    ...
    $image_url = ! post_password_required() ? get_the_post_thumbnail_url( get_the_ID(), 'cadus-fullscreen' ) : '';
            ...
            <div class="cover-header-inner">
                ...
                <header class="entry-header has-text-align-center">
                    <div class="entry-header-inner section-inner medium">
                         ...
                         */
                        $show_categories = apply_filters( 'cadus_show_categories_in_entry_header', true );

                        if ( true === $show_categories && has_category() ) {
                            ?>

                            <div class="entry-categories">
                                <span class="screen-reader-text"><?php _e( 'Categories', 'cadus' ); ?></span>
                        ...
                        if ( is_page() ) {
                            ...
                            <div class="to-the-content-wrapper">
                                ...
                                <a href="#post-inner" class="to-the-content fill-children-current-color">
                                    <?php cadus_the_theme_svg( 'arrow-down' ); ?>
                                    <div class="screen-reader-text"><?php _e( 'Scroll Down', 'cadus' ); ?></div>
                                </a><!-- .to-the-content -->
    ...
    <div class="post-inner" id="post-inner">
        ...
        wp_link_pages(
            array(
                'before'      => '<nav class="post-nav-links bg-light-background" aria-label="' . esc_attr__( 'Page', 'cadus' ) . '"><span class="label">' . __( 'Pages:', 'cadus' ) . '</span>',
                'after'       => '</nav>',
